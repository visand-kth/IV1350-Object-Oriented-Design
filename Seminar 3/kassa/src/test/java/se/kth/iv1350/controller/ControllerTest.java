...
public class ControllerTest {
    ...
    public void setUp(){
        ...
        Item testItem;
        testItem = new Item(101, 2, "BigWheel Oatmeal", 29.9F, 0.06F, "BigWheel Oatmeal 500 g, whole grain oats, 7 high fiber, gluten free");
        System.out.println("Add 2 item with item id 101:");
        controller.addItem(testItem);
        System.out.println("Add 2 item with item id 101:");
        controller.addItem(testItem);
        testItem = new Item(102, 1, "YouGoGo Blueberry", 14.9F, 0.06F, "YouGoGo Blueberry 240g, low sugar yoghurt, blueberry flavour.");
